/*
	...
	Date:	      16.07.20 20:11
	Description:  (Computer-Assisted Instruction: Difficulty Levels) Exercises 5.50– through Exercise 5.52
					developed a computer-assisted instruction program to help teach an elementary-school student multiplication. 
					Modify the program to allow the user to enter a difficulty level. At a difficulty level of
